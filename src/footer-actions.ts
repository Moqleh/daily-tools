...
function enhanceFooter(){
 ...
 if(contact&&!contact.querySelector('.dt-whatsapp')){
  ...
  wa.setAttribute('aria-label',isAr()?'تواصل عبر واتساب':'Contact on WhatsApp');
  wa.title=isAr()?'تواصل عبر واتساب':'Contact on WhatsApp';
  wa.innerHTML='<svg viewBox="0 0 32 32" aria-hidden="true"><path fill="currentColor" d="M16.03 3C8.86 3 3.03 8.83 3.03 16c0 2.29.6 4.52 1.75 6.48L3 29l6.7-1.75A12.94 12.94 0 0 0 16.03 29C23.2 29 29 23.17 29 16S23.2 3 16.03 3Zm0 23.82a10.8 10.8 0 0 1-5.5-1.5l-.4-.24-3.98 1.04 1.06-3.88-.26-.4A10.78 10.78 0 0 1 5.21 16c0-5.96 4.86-10.82 10.82-10.82 5.97 0 10.8 4.86 10.8 10.82s-4.83 10.82-10.8 10.82Zm5.93-8.1c-.32-.16-1.9-.94-2.2-1.04-.29-.11-.5-.16-.71.16-.22.32-.83 1.04-1.02 1.25-.19.21-.37.24-.7.08-.32-.16-1.36-.5-2.59-1.6a9.76 9.76 0 0 1-1.8-2.24c-.19-.32-.02-.5.14-.65.15-.14.32-.37.48-.56.16-.19.22-.32.32-.54.11-.21.06-.4-.02-.56-.08-.16-.72-1.73-.99-2.37-.26-.63-.53-.54-.72-.55h-.61c-.21 0-.56.08-.85.4-.29.32-1.12 1.1-1.12 2.66 0 1.57 1.15 3.08 1.31 3.3.16.21 2.26 3.45 5.47 4.84.76.33 1.36.53 1.83.68.77.25 1.46.21 2.01.13.61-.09 1.9-.78 2.17-1.53.27-.75.27-1.4.19-1.53-.08-.14-.3-.22-.62-.38Z"/></svg>';
...
const css=document.createElement('style');css.textContent=`.dt-whatsapp{display:inline-grid;place-items:center;width:42px;height:42px;margin-top:8px;border-radius:50%;background:#25D366;color:#fff;text-decoration:none;box-shadow:0 6px 16px rgba(37,211,102,.28);transition:transform .18s ease,box-shadow .18s ease}.dt-whatsapp svg{width:25px;height:25px;display:block}.dt-whatsapp:hover{transform:translateY(-2px) scale(1.04);box-shadow:0 9px 20px rgba(37,211,102,.34)}.dt-whatsapp:focus-visible{outline:3px solid rgba(37,211,102,.35);outline-offset:3px}.dt-legal-link{border:0;background:none;padding:0;color:inherit;font:inherit;font-weight:800;cursor:pointer}.dt-legal-link:hover{text-decoration:underline}.dt-legal-back{position:fixed;inset:0;z-index:10000;background:rgba(8,31,51,.58);display:grid;place-items:center;padding:20px}.dt-legal{position:relative;width:min(92vw,650px);background:#fff;color:#18384f;border-radius:22px;padding:30px;box-shadow:0 24px 70px rgba(0,0,0,.25);line-height:1.9}.dt-legal h2{margin:0 0 14px;color:#174f78}.dt-legal p{margin:0}.dt-legal-close{position:absolute;top:10px;inset-inline-end:14px;border:0;background:none;font-size:30px;cursor:pointer;color:#587487}`;document.head.appendChild(css);
